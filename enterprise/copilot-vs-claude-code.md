...
Both Copilot CLI and Claude Code default to a **Claude Sonnet** model (Sonnet 4.6 in Copilot CLI as of September 2026, after Sonnet 4.5 was retired on 2026-09-01; both are 1×). The mental model — the Four Pillars, plan mode, Skills, hooks, MCPs — is identical. Most of what you learn in one transfers to the other.
...
- **Multi-model.** First-class `/model` switching to GPT-6 Astra and Gemini 3.8 Flash alongside Claude Opus and Sonnet.
